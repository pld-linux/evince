...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/evince/2.25/%{name}-%{version}.tar.bz2
# Source0-md5:	53e6774241d08347fda26ff98cac2aff
...
BuildRequires:	gnome-icon-theme >= 2.25.90
...
BuildRequires:	nautilus-devel >= 2.25.0
